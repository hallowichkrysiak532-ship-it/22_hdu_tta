...
#ifndef TTA_CAMERA_MANAGER_H
#define TTA_CAMERA_MANAGER_H
 ...
 */
T_DjiReturnCode DjiTta_CameraManagerSetEV(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetExposureMode(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetISO(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetShutterSpeed(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetAperture(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetFocusPoint(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerSetTapZoomPoint(E_DjiMountPosition position, uint8_t multiplier,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartContinuousZoom(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerOpticalZoom(E_DjiMountPosition position,
                                                 E_DjiCameraZoomDirection zoomDirection,
                                                 dji_f32_t factor);
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStopContinuousZoom(E_DjiMountPosition position);
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartShootSinglePhoto(E_DjiMountPosition position);
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartShootBurstPhoto(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartShootAEBPhoto(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartShootIntervalPhoto(E_DjiMountPosition position,
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStopShootPhoto(E_DjiMountPosition position);
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStartRecordVideo(E_DjiMountPosition position);
 ...
 *  @return T_DjiReturnCode error code
 */
T_DjiReturnCode DjiTta_CameraManagerStopRecordVideo(E_DjiMountPosition position);
